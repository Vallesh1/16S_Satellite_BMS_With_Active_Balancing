...
set OUTPUTS_DIR "/home1/IITR_PD3/MulukuriVNath/Documents/16S_Satellite_BMS_With_Active_Balancing/synthesis/top/outputs"

set SCRIPTS "/home1/IITR_PD3/MulukuriVNath/Documents/16S_Satellite_BMS_With_Active_Balancing/synthesis/top/scripts"
...
#Analyze
analyze -f verilog [glob $rtl_path_1 $rtl_path_2 $rtl_path_3 $rtl_path_4]

foreach path $rtl_path_1 {
    analyze -f verilog [glob $path/*.v]
}

foreach path $rtl_path_2 {
    analyze -f verilog [glob $path/*.v]
}

foreach path $rtl_path_3 {
    analyze -f verilog [glob $path/*.v]
}

foreach path $rtl_path_4 {
    analyze -f verilog [glob $path/*.v]
}
